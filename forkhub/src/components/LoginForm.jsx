...
export default function LoginForm({ nextPath, onSuccess, onRequestRegister, onClose }) {
  ...
  return (
    <div className="modal-card" style={{ margin: '0 auto' }}>
      ...
      <h1 style={{ margin: 0, fontSize: 46, textTransform: 'uppercase', paddingRight: 48 }}>
      ...
      <p className="muted" style={{ marginTop: 12 }}>
        ...
        <span
          ...
          onKeyDown={(e) => e.key === 'Enter' && onRequestRegister()}
          role="button"
          tabIndex={0}
        >
          Create One
